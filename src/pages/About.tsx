...
const About = () => {
  ...
  const coreValues = [
    ...
    },
    {
      ...
      description:
        "Continuously advancing pharmaceutical science through dedicated research and development for a healthier tomorrow.",
      color: "pharma-green",
      delay: "0.3s",
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-16 md:gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-slate-700 text-lg leading-relaxed">
                <p>
                  For over a decade, Luxem Pharmaceuticals has been a beacon of
                  innovation in the healthcare sector. Our core mission is to
                  develop, manufacture, and deliver high-quality pharmaceutical
                ...
                <p>
                  ...
                  push the boundaries of pharmaceutical excellence, ensuring
