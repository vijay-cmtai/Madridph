...
import { Calendar, MapPin, Users, Clock, Image as ImageIcon, Play } from 'lucide-react';
  ...
  const events = [
    {
      ...
      description: 'Join us at the leading pharmaceutical conference discussing innovations in drug development.',
    ...
    },
    {
      ...
      description: 'Exploring the future of healthcare through technological advancements and pharmaceutical breakthroughs.',
    ...
    },
    {
      ...
      description: 'Presenting latest research findings in neurology, cardiology, and immunology.',
    ...
    },
    {
      ...
      description: 'Workshop on maintaining international quality standards in pharmaceutical manufacturing.',
    ...
    },
    {
      ...
      description: 'Building partnerships for global health initiatives and accessible healthcare.',
    ...
    },
    {
      ...
      description: 'Discussing emerging trends in personalized medicine and precision healthcare.',
      ...
      <section className="relative bg-gradient-to-r from-blue-900 via-purple-900 to-pink-900 text-white py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed mb-10">
            Join us at upcoming pharmaceutical events, conferences, and medical symposiums 
            where innovation meets collaboration in the healthcare industry
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <div className="bg-white/10 backdrop-blur-md rounded-full px-6 py-3 border border-white/20">
              <span className="text-white font-semibold">20+ Annual Events</span>
            </div>
            <div className="bg-white/10 backdrop-blur-md rounded-full px-6 py-3 border border-white/20">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-700 text-xl max-w-4xl mx-auto leading-relaxed">
              Stay updated with our latest events, conferences, and industry gatherings where we share 
              knowledge, innovations, and connect with healthcare professionals worldwide.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {events.map((event, index) => (
              <div key={index} className="group relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-6 border border-gray-100">
                <div className="relative h-64 overflow-hidden">
                  ...
                  {/* Category Badge */}
                  <div className={`absolute top-4 right-4 bg-gradient-to-r ${event.color} text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg backdrop-blur-sm`}>
                    {event.category}
                  </div>
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex items-center text-gray-600">
                      <div className={`bg-gradient-to-r ${event.color} rounded-xl w-10 h-10 flex items-center justify-center mr-4 shadow-lg`}>
                  ...
                  <button className={`w-full bg-gradient-to-r ${event.color} text-white py-4 px-6 rounded-2xl font-bold hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-xl group-hover:scale-105`}>
                    Read More
                  </button>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-700 text-xl max-w-3xl mx-auto leading-relaxed">
              Explore memorable moments from our previous events and conferences through our comprehensive gallery
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {galleryImages.map((item, index) => (
              <div key={index} className="group relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-4 border border-gray-100">
                <div className="relative h-64 overflow-hidden">
                  <img 
                    src={item.image} 
                    alt={item.title}
          ...
          <div className="mt-20 grid md:grid-cols-4 gap-8">
            {[
              { number: "50+", label: "Events Conducted", color: "from-blue-500 to-blue-600" },
              { number: "10K+", label: "Attendees", color: "from-green-500 to-green-600" },
              { number: "25+", label: "Countries Reached", color: "from-purple-500 to-purple-600" },
              { number: "15+", label: "Years Experience", color: "from-pink-500 to-pink-600" },
            ].map((stat, index) => (
              <div key={index} className="text-center bg-white/50 backdrop-blur-sm rounded-3xl p-8 border border-white/50 hover:bg-white/80 transition-all duration-300">
